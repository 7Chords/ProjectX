...
{
    public class UIPanelCharacterProps : _ASCUIPanelBase<UIMonoCharacterProps>
    {
        private TBSActorInfo _m_actorInfo;

        public UIPanelCharacterProps(UIMonoCharacterProps _mono, SCUIShowType _showType) : base(_mono, _showType)
        {
        }
